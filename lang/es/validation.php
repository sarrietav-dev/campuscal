...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute ha aparecido en una filtración de datos. Elija otro :attribute.',
    ],
    ...
    | una línea de lenguaje personalizada específica para una regla de atributo dada.
    |
    */
    ...
    | de atributos con algo más amigable para el lector, como "Dirección de correo electrónico" en lugar de "email".
